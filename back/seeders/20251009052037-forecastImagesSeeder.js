...
import { getAllForecast } from '../repositories/forecast.repository.js';
...
export default {
  async up (queryInterface, Sequelize) {
    ...
    const IMAGE_CUT_NAME_LIST = ['gif_0', 'gif_6', 'gif_12', 'gif_18', 'gif_24', 'gif_30'];
    ...
    for await (const forecast of resultForecasts) {
      ...
      const codeIdx = INFORM_CODE_LIST.indexOf(forecast.informCode);
      ...
      const cutFile1 = `${baseFilePath}/AQF.${fileDate}.NIER_09_01.${IMAGE_INFORM_CODE_LIST[codeIdx]}.2days.ani.${IMAGE_CUT_NAME_LIST[0]}.gif`;
      const cutFile2 = `${baseFilePath}/AQF.${fileDate}.NIER_09_01.${IMAGE_INFORM_CODE_LIST[codeIdx]}.2days.ani.${IMAGE_CUT_NAME_LIST[1]}.gif`;
      const cutFile3 = `${baseFilePath}/AQF.${fileDate}.NIER_09_01.${IMAGE_INFORM_CODE_LIST[codeIdx]}.2days.ani.${IMAGE_CUT_NAME_LIST[2]}.gif`;
      const cutFile4 = `${baseFilePath}/AQF.${fileDate}.NIER_09_01.${IMAGE_INFORM_CODE_LIST[codeIdx]}.2days.ani.${IMAGE_CUT_NAME_LIST[3]}.gif`;
      const cutFile5 = `${baseFilePath}/AQF.${fileDate}.NIER_09_01.${IMAGE_INFORM_CODE_LIST[codeIdx]}.2days.ani.${IMAGE_CUT_NAME_LIST[4]}.gif`;
      const cutFile6 = `${baseFilePath}/AQF.${fileDate}.NIER_09_01.${IMAGE_INFORM_CODE_LIST[codeIdx]}.2days.ani.${IMAGE_CUT_NAME_LIST[5]}.gif`;
