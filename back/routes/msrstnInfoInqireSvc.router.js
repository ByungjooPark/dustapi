...
// 측정소 목록 조회
router.get('/getMsrstnList', getMsrstnListValidator, validationHandler, msrstnList);

// 근접측정소 목록 조회
router.get('/getNearbyMsrstnList', getNearbyMsrstnListValidator, validationHandler, nearbyMsrstnList);

// TM 기준좌표 조회
router.get('/getTMStdrCrdnt', getMsrstnListValidator, validationHandler, tmstdrCrdnt);
